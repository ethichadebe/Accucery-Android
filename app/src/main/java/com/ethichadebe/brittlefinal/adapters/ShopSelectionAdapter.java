...
public class ShopSelectionAdapter extends RecyclerView.Adapter<ShopSelectionAdapter.ShopItemViewHolder> {
    ...
    public ShopItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.shop_item_selection, parent, false);
